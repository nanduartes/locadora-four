...
CREATE TABLE `tb_usuario` (
  ...
  `sessao` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_tb_usuario` (`id`)
...
INSERT INTO `tb_usuario` VALUES (1,'fernando@souza.com.br','Fernando Duarte','159753',624131,'2019-10-02 23:18:59');
